...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Intersection: "+getIntersectionNode(n1,n4).val);
        ...
        System.out.println("Intersection: "+getIntersectionNode(n7,n9));
    ...
    public ListNode getIntersectionNodeOriginal(ListNode headA, ListNode headB) {
        ...
        while (l1 != l2) {
            ...
            //They will coincide during the first or second run when they change lists, if not they will both be null
            //meaning that they don't have an intersection
            if (l1 == null) {
                l1 = headB;
            } else {
                l1 = l1.next;
