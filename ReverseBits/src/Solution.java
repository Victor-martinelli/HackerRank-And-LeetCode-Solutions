...
In this case, both input and output will be given as signed integer type and should
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The bits of "+n+" reversed are: "+reverseBits(n));
        
    }
    
     public static int reverseBitsOriginal(int n) {
   ...
   public static int reverseBits(int n) {
        ...
        for(int i=0;i<32;i++)
        {
       //       Insert into result  Extract last bit
            result = result<<1 | (n&1);
